        ...
        <div class="modal-content">
            ...
            <div class="d-flex flex-column modal-body text-center">
                <a href="#" type="submit" class="btn btn-success" data-toggle="modal"
                   data-target=".bs-example-modal-lg-ATM">
                    ATM
                </a>
                <a href="#" type="submit" class="btn btn-success" data-toggle="modal"
                   data-target=".bs-example-modal-lg-InternetBanking">
                    Internet Banking
                </a>
                <a href="#" type="submit" class="btn btn-success" data-toggle="modal"
                   data-target=".bs-example-modal-lg-MobileBanking">
                    Mobile Banking
                </a>
            </div>
...
{{-- modal ATM --}}
<div class="modal fade bs-example-modal-lg-ATM" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="modal fade bs-example-modal-lg-InternetBanking" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
...
<div class="modal fade bs-example-modal-lg-MobileBanking" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
