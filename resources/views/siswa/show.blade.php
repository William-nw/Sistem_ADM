...
<div class="row">
    <div class="col-md-12 col-sm-12 mb-5">
        <ul class="list-unstyled user_data">
            @foreach ($data as $itemSiswa)                
                <li>
                    <i class="fa fa-key user-profile-icon"></i> 
                    NIS : {{ $itemSiswa->dataSiswa->nis}}
                </li>
                <li>
                    <i class="fa fa-user user-profile-icon"></i> 
                    Nama : {{ $itemSiswa->dataSiswa->nama_siswa}}
                </li>
                <li>
                    <i class="fa fa-building user-profile-icon"></i> 
                    Kelas : {{ $itemSiswa->dataSiswa->nama_kelas}}
                </li>
                <li>
                    <i class="fa fa-book user-profile-icon"></i> 
                    Tahun Ajaran : {{ $itemSiswa->dataSiswa->tahun_ajaran}}
                </li>
                <li>
                    <i class="fa fa-book user-profile-icon"></i> 
